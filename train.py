...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_traj_len", type=int, default=1024, help="Max episode horizon")#每轮采样都是self.n_proc * self.max_traj_len个176
    parser.add_argument("--eval_freq", required=False, default=20, type=int, help="Frequency of performing evaluation")
    parser.add_argument("--continued", required=False, default=True, type=str, help="path to pretrained weights")
    parser.add_argument("--env_batch_size", required=False, default=200, type=int, help="path to pretrained weights")
